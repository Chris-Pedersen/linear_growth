...
#FOF_SECONDARY_LINK_TYPES=1+16       # 2^type for the types linked to nearest primaries
#FOF_GROUP_MIN_LEN=128              # default is 32
#SUBFIND                            # enables substructure finder
#DENSITY_SPLIT_BY_TYPE=1+2+16       # 2^type for whch the densities should be calculated seperately  
...
#KSPACE_NEUTRINOS             #Fourier-space integration of neutrinos
#KSPACE_NEUTRINOS_2           #Improved Fourier-space integration of neutrinos from Ali-Haimoud & Bird 2013.
#INCLUDE_RADIATION
...
LINEOFSIGHTTABLE              # uses table format for line-of-sight redshifts -- see lineofsight.c 
#OUTPUTPROJECTEDPLANE          # enables on the fly generation of projected slices for movies (y-z plane)
...
#MAGNETIC_DIFFUSION_LIMIT   # Limits transport distance for B
